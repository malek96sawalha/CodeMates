...
<header class="top-navbar">
    ...
    height: 41px; border-radius: 12px;">Register</a>
                    <a href="cart.html" class="nav-item nav-link" style="background-color: transparent;"><img src="images/Shopping_cart_icon.svg.png"  width="30px" style="width: 30px !important;"> <span style="color: white;">cart</span></a>
                  </div>
					</ul>
				</div>
			</div>
  ...
  <div id="single-header">
	<div class="all-page-title page-breadcrumb ">
		<div class="container text-center">
			<div class="row">
				<div class="col-lg-12">
          <p class="path" style="padding: 115px 0 0 0 !important;"></p>
